...
namespace vem {
// per-boundary element integrals (integrals along edges in 2D)
class BoundaryMomentBasisIndexer : public PartitionedCoefficientIndexer {
  public:
    // pass in the number of samples are held on the interior of each edge
    BoundaryMomentBasisIndexer(const VEMMesh2 &mesh, size_t num_moments);
    explicit BoundaryMomentBasisIndexer(const VEMMesh2 &mesh,
                                        const std::vector<size_t> &num_moments);
    BoundaryMomentBasisIndexer(const BoundaryMomentBasisIndexer &) = default;
    BoundaryMomentBasisIndexer(BoundaryMomentBasisIndexer &&) = default;
    BoundaryMomentBasisIndexer &operator=(const BoundaryMomentBasisIndexer &) = default;
    BoundaryMomentBasisIndexer &operator=(BoundaryMomentBasisIndexer &&) = default;
...
template<typename Func>
mtao::VecXd BoundaryMomentBasisIndexer::evaluate_coefficients(Func &&f) const {
...
template<typename Func>
mtao::ColVecs2d BoundaryMomentBasisIndexer::evaluate_vector_field(Func &&f) const {
...
template<typename Func>
mtao::VecXd BoundaryMomentBasisIndexer::evaluate_coefficients(size_t cell_index,
                                                              Func &&f) const {
...
template<typename Func>
mtao::ColVecs2d BoundaryMomentBasisIndexer::evaluate_vector_field(size_t cell_index,
                                                                  Func &&f) const {
    mtao::ColVecs2d R(2, num_coefficients());
    for (int j = 0; j < _mesh.V.cols(); ++j) {
        R.col(j) = f(_mesh.V.col(j));
