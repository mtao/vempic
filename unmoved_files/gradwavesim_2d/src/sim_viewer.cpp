...
SimViewer::SimViewer(Sim &sim, mtao::opengl::Object2D *parent, Magnum::SceneGraph::DrawableGroup2D *group)
  : mtao::opengl::Object2D{ parent },
    Magnum::SceneGraph::Drawable2D{ *this, group },
    _sim(sim),
    scalar_field_viewer(sim.mesh(), sim.poisson_vem.monomial_indexer(), &drawables),
...
void SimViewer::draw(const Magnum::Matrix3 &transformationMatrix,
    ...
    vf_shader.setTransformationProjectionMatrix(camera.projectionMatrix() * transformationMatrix);
    flat_shader.setTransformationProjectionMatrix(camera.projectionMatrix() * transformationMatrix);
